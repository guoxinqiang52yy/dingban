<!--
 * @Author:  树状图测试
 * @Date: 2020-08-14 11:48:59
 * @LastEditTime: 2020-08-14 11:58:59
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \backstage\src\components\tree\treetest.vue
-->
<!--  -->
<template>
  <div>
    <el-tree ref="eventCategoryTree" :data="eventCategoryTree" :props="defaultProps" node-key="id" highlight-current default-expand-all :render-content="renderContent" :expand-on-click-node="false"> </el-tree>
...
<script>
import TreeRender from './treeTesList'
export default {
  name: "",
  components: {},
  props: [],
