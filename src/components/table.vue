    ...
    <section class="ces-table-page">
        ...
        <section class="ces-table">
            <el-table :row-key="row_key"
                ...
                <el-table-column v-if="isIndex" type="index" :label="indexLabel" align="center"
                ...
                >
                    ...
                    <el-button v-for="btn in item.btnList" :key="btn.label"
                        ...
                        <el-radio-group v-if="item.type==='radio'" v-model="scope.row[item.prop]"
                                        ...
                                        :size="size || btn.size"
                                        @change='item.change && item.change(that,scope.row)'>
                            <el-radio v-for="ra in item.radios" :label="ra.value" :key="ra.value">{{ra.label}}
                            </el-radio>
                        </el-radio-group>
                        <!-- 复选框 -->
                        <el-checkbox-group v-if="item.type==='checkbox'" v-model="scope.row[item.prop]"
                                           ...
                                           :size="size || btn.size"
                                           @change='item.change && item.change(that,scope.row)'>
                            <el-checkbox v-for="ra in item.checkboxs" :label="ra.value" :key='ra.value'>{{ra.label}}
                            </el-checkbox>
                        </el-checkbox-group>
                        <!-- 评价 -->
                        ...
                        <!-- 默认 -->
                        <span v-if="!item.type" show-overflow-tooltip="true"
                            ...
                            <span v-if="item.type_link">
                                <el-link :type="item.type_link.type"
                                         :disabled="item.type_link.disabled"
                                         :icon="item.type_link.icon"
                                         @click="item.type_link.handle(that,scope.row)">{{btn.label}}</el-link>
                                </span>
                        </span>
                    </template>
                </el-table-column>
